#!/bin/sh
#-###############################################-#
# C++ Cross-Compiler - The Auhcore Developer-2018 #
#-###############################################-#
...
[ -f "./src/qt/auh-qt.exe" ] && cp "./src/qt/auh-qt.exe" "$RELEASE"
[ -f "./src/auhd.exe" ] && cp "./src/auhd.exe" "$RELEASE"
[ -f "./src/auh-cli.exe" ] && cp "./src/auh-cli.exe" "$RELEASE"
