...
from test_framework.test_framework import AuhTestFramework, SkipTest
...
class ZMQTest (AuhTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that auh has been built with ZMQ enabled
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("auhd has not been built with zmq enabled.")
