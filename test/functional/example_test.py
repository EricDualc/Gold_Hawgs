...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the AuhTestFramework
    pass

class ExampleTest(AuhTestFramework):
    # Each functional test is a subclass of the AuhTestFramework class.
    ...
    def custom_method(self):
        ...
        AuhTestFramework class so other tests can use it."""
