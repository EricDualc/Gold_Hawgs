...
/////////////////////////////////////////// auh
#include <auh/auhstate.h>
#include <auh/auhDGP.h>
#include <libethereum/ChainParams.h>
#include <libethashseal/Ethash.h>
#include <libethashseal/GenesisInfo.h>
#include <script/standard.h>
#include <auh/storageresults.h>
///////////////////////////////////////////

extern std::unique_ptr<AuhState> globalState;
...
using ExtractAuhTX = std::pair<std::vector<AuhTransaction>, std::vector<EthTransactionParams>>;
///////////////////////////////////////////
...
static const int64_t DARKSEND_COLLATERAL = (2500*COIN); //2500 AUH
...
extern unsigned int dgpMaxBlockSize; // auh
...
class AuhTxConverter{

public:

    AuhTxConverter(CTransaction tx, CCoinsViewCache* v = NULL, const std::vector<CTransaction>* blockTxs = NULL) : txBit(tx), view(v), blockTransactions(blockTxs){}

    bool extractionAuhTransactions(ExtractAuhTX& auhTx);
...
private:
    ...
    AuhTransaction createEthTX(const EthTransactionParams& etp, const uint32_t nOut);
...
public:
    ...
    ByteCodeExec(const CBlock& _block, std::vector<AuhTransaction> _txs, const uint64_t _blockGasLimit) : txs(_txs), block(_block), blockGasLimit(_blockGasLimit) {}
