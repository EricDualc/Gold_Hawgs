...
#ifndef AUH_TRADINGDIALOG_H
#define AUH_TRADINGDIALOG_H
...
private slots:
    ...
    void showBalanceOfAUHOnTradingTab();
    ...
    void showBalanceOfAUHOnSendTab();
    void showBalanceOfAUHOnBalanceTab();
    ...
    QString BuyAUH(QString OrderType, double Quantity, double Rate);
    QString SellAUH(QString OrderType, double Quantity, double Rate);
    ...
    QString sendRequest(QString url, QString method = "GET", QString body = QString("{\"market\":\"AUH/BTC\"}"));// "{\"gender\":\"male\"}");
    void sendRequest1(QString url, std::function<void (void)> funcForCallAfterReceiveResponse, QString method = "GET", QString body = QString("{\"market\":\"AUH/BTC\"}"));// "{\"gender\":\"male\"}");
