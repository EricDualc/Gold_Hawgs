...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(AUH);
    unitlist.append(mAUH);
    unitlist.append(uAUH);
    return unitlist;
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case AUH:
            return QString("tAUH");
        case mAUH:
            return QString("mtAUH");
        case uAUH:
            return QString::fromUtf8("μtAUH");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case AUH:
            return QString("AUH");
        case mAUH:
            return QString("Milli-AUH (1 / 1" THIN_SP_UTF8 "000)");
        case uAUH:
            return QString("Micro-AUH (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case AUH:
            return QString("TestAUHs");
        case mAUH:
            return QString("Milli-TestAUH (1 / 1" THIN_SP_UTF8 "000)");
        case uAUH:
            return QString("Micro-TestAUH (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
