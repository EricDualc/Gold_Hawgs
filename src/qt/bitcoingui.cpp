                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    resize(1200, 735);
    QString windowTitle = tr("Auhcore") + " - ";

#ifdef ENABLE_UPDATER
    controller = new QtAuhUpdater::UpdateController(QStringLiteral("v1.0.0"), this);
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle) {
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a AUH address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and auh: URIs)"));
...
//    connect(tradingAction, SIGNAL(triggered()), this, SLOT(gotoTradingPage()));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Auhcore"), this);
    aboutAction->setStatusTip(tr("Show information about Auhcore"));
    aboutAction->setMenuRole(QAction::AboutRole);

    // Check for update menu item
//    checkForUpdateAction = new QAction(QIcon(":/icons/update"), tr("Check for &Update"), this);
//    checkForUpdateAction->setStatusTip(tr("Check whether there is an updated wallet from Auhcore"));
//    checkForUpdateAction->setMenuRole(QAction::NoRole);
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for AUH"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your AUH addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified AUH addresses"));
...
//    openRepairAction->setStatusTip(tr("Show wallet repair options"));
    ...
    openAction->setStatusTip(tr("Open a AUH: URI or payment request"));
...
//    openHexAddressAction = new QAction(QIcon(":/icons/explorer"), tr("&Hex Address Converter"), this);
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Auhcore help message to get a list with possible AUH command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle) {
    ...
    QString toolTip = tr("Auhcore client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updaterClicked() {
    if (!clientModel)
        return;
#ifdef ENABLE_UPDATER
    controller->start(QtAuhUpdater::UpdateController::ProgressLevel);
#else
...
void BitcoinGUI::updateNetworkState() {
    ...
    if (clientModel->getNetworkActive())
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Auhcore network", "", count));
    else
...
void BitcoinGUI::message(const QString& title, const QString& message, unsigned int style, bool* ret) {
    QString strTitle = tr("Auhcore"); // default title
