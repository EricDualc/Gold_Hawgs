...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Auh features */
        {"auh", "masternode", &masternode, true, true, false},
        //{"auh", "masternodelist", &masternodelist, true, true, false},
        //{"auh", "mnbudget", &mnbudget, true, true, false},
        //{"auh", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        //{"auh", "mnfinalbudget", &mnfinalbudget, true, true, false},
        //{"auh", "mnsync", &mnsync, true, true, false},
        {"auh", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        //{"auh", "darksend", &darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
{
    return "> auh-cli " + methodname + " " + args + "\n";
}
