...
#include "genesis/auhMainNetwork.cpp"
#include "genesis/auhTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
	...
	case Network::auhMainNetwork: return c_genesisInfoAuhMainNetwork;
	case Network::auhTestNetwork: return c_genesisInfoAuhTestNetwork;
	default:
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
	...
	case Network::auhMainNetwork: return c_genesisStateRootAuhMainNetwork;
	case Network::auhTestNetwork: return c_genesisStateRootAuhTestNetwork;
	default:
		throw std::invalid_argument("Invalid network value");
	}
}
