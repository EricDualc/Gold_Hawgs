...
////////////////////////////////////////////////////////////// // auh
	void setAuhSchedule(EVMSchedule _auhSchedule) const { auhSchedule = _auhSchedule; }

	EVMSchedule& getAuhSchedule() const { return auhSchedule; }
...
private:
	...
	mutable EVMSchedule auhSchedule; // auh
