...
public:
    ...
    bool WriteAuhNodeConfig(std::string sAlias, const CAuhNodeConfig& nodeConfig);
    bool ReadAuhNodeConfig(std::string sAlias, CAuhNodeConfig& nodeConfig);
    bool EraseAuhNodeConfig(std::string sAlias);
