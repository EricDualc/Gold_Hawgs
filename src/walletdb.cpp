...
bool CWalletDB::WriteAuhNodeConfig(std::string sAlias, const CAuhNodeConfig& nodeConfig)
{
    nWalletDBUpdated++;
    return Write(std::make_pair(std::string("adrenaline"), sAlias), nodeConfig, true);
}

bool CWalletDB::ReadAuhNodeConfig(std::string sAlias, CAuhNodeConfig& nodeConfig)
{
    return Read(std::make_pair(std::string("adrenaline"), sAlias), nodeConfig);
}

bool CWalletDB::EraseAuhNodeConfig(std::string sAlias)
{
    nWalletDBUpdated++;
