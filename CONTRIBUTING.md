Contributing to Auhcore
============================

The Auhcore project operates an open contributor model where anyone is
...
The following applies to code changes to the Auhcore project, and is not to be
confused with overall AUH Network Protocol consensus changes.

Whether a pull request is merged into Auhcore rests with the project merge
...
Patches that change AUH consensus rules are considerably more involved than
...
Where a patch set proposes to change the AUH consensus, it must have been
...
The project leader is the release manager for each Auhcore release.
