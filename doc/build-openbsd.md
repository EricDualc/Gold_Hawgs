...
This guide describes how to build auhd and command-line utilities on OpenBSD.
...
git clone https://github.com/AUH-Core/auh.git
```
...
(see issue [#6658](https://github.com/AUH-Core/auh/issues/)).
