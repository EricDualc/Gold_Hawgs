...
In order to support loading of multiple wallets in auh-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is auh.cpp.
...
Changes to auh.cpp
----------------------
auh.cpp is the entry point into auh-qt, and as such, will require some minor modifications to provide hooks for
