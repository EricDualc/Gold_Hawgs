...
This means one can have an always-on auhd instance running, and another local auhd/auh-qt instance which connects to this node and receives blocks from it.
